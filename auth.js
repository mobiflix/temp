...
function hideLoginScreen() {
  ...
  // ============================================
  //   ✅ AUTO-UPDATE NG CONTENT PAGKATAPOS MAG-LOGIN
  // ============================================
  // Ito ang nag-trigger ng pag-fetch ng mga bagong
  // Movies, TV Series, at Korean Series mula sa TMDB
  setTimeout(function() {
    if (typeof refreshHomeContent === 'function') {
      console.log('[MobiFlix] Auto-updating content after login...');
      refreshHomeContent();
    }
  }, 500);
