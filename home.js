...
function showDetails(item) {
  ...
  // 👇 Siguraduhing visible ang modal back bar sa details view
  const modalBackBar = document.querySelector('.modal-back-bar');
  if (modalBackBar) modalBackBar.classList.remove('hidden');
...
function playNow() {
  ...
  // 👇 ITAGO ANG MODAL BACK BAR KAPAG NAGPE-PLAY
  const modalBackBar = document.querySelector('.modal-back-bar');
  if (modalBackBar) modalBackBar.classList.add('hidden');
